...
- **Custom Stickers** ([#2476](https://github.com/IsmaelMartinez/teams-for-linux/issues/2476), shipped v2.11.0 in [PR #2550](https://github.com/IsmaelMartinez/teams-for-linux/pull/2550), opt-in via `customStickers.enabled`): Telegram sticker-pack import and prompt-driven generation through a user-configured endpoint (mirroring the `customBackground` pattern) only if requested.
