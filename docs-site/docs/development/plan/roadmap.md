...
- **Wayland Compatibility**: `--ozone-platform=x11` remains the shipped default. Two removal attempts were reverted: [PR #2506](https://github.com/IsmaelMartinez/teams-for-linux/pull/2506) in [PR #2600](https://github.com/IsmaelMartinez/teams-for-linux/pull/2600), and the Electron 42 retry [PR #2601](https://github.com/IsmaelMartinez/teams-for-linux/pull/2601) closed unmerged; the community testing tracker [#2508](https://github.com/IsmaelMartinez/teams-for-linux/issues/2508) closed June 2026 with the same verdict. Decision and reopen triggers recorded in [ADR-031](../adr/031-ozone-platform-x11-default.md). Live: [wayland](https://github.com/IsmaelMartinez/teams-for-linux/issues?q=is%3Aissue+is%3Aopen+label%3Awayland).
