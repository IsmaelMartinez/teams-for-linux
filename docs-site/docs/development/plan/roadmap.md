...
- **MQTT Integration**: presence, media state, screen-share topics shipped. Home Assistant auto-discovery shipped ([PR #2464](https://github.com/IsmaelMartinez/teams-for-linux/pull/2464), [PR #2571](https://github.com/IsmaelMartinez/teams-for-linux/pull/2571)). Microphone state shipped ([PR #2497](https://github.com/IsmaelMartinez/teams-for-linux/pull/2497)). Incoming-call topic in review ([PR #2572](https://github.com/IsmaelMartinez/teams-for-linux/pull/2572)). Camera renderer wiring pending. Live: [mqtt](https://github.com/IsmaelMartinez/teams-for-linux/issues?q=is%3Aissue+is%3Aopen+label%3Amqtt).
