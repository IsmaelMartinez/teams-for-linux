...
| Wayland/X11 Ozone Platform | v2.7.4 | Force X11 by default due to Electron 38+ Wayland regressions; re-affirmed May 2026 after [#2506](https://github.com/IsmaelMartinez/teams-for-linux/pull/2506) was reverted, decision now in [ADR-031](../adr/031-ozone-platform-x11-default.md) |
