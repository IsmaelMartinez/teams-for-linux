...
>
> **Last Generated**: 2026-06-15T18:46:50.777Z
...
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:345`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L345) |
...
| `secure-prompt:cancel` | Event | Dialog cancelled by the user (Cancel button) | [`app/_shared/securePrompt.js:92`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/_shared/securePrompt.js#L92) |
| `secure-prompt:submit` | Event | Secret submitted from the dialog form | [`app/_shared/securePrompt.js:90`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/_shared/securePrompt.js#L90) |
