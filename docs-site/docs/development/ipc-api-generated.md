...
>
> **Last Generated**: 2026-08-23T17:56:41.661Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:220`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L220) |
| `dock-icon-update` | Event | Update Dock icon with status overlay on macOS | [`app/index.js:243`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L243) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:258`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L258) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:222`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L222) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:281`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L281) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:263`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L263) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:272`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L272) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:240`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L240) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:290`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L290) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:238`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L238) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:322`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L322) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:308`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L308) |
| `profile-switcher-open-add` | Event | Switcher pill "Add profile…" link opens the existing Add-profile dialog. | [`app/menus/index.js:235`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L235) |
| `profile-switcher-open-manage` | Event | Switcher pill "Manage profiles…" link opens the existing Manage dialog. | [`app/menus/index.js:237`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L237) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:314`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L314) |
...
| `app-registration-auth-status` | Request/Response | No description available | [`app/auth/index.js:31`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/auth/index.js#L31) |
...
| `webauthn:create` | Request/Response | Handle credential creation requests from renderer | [`app/webauthn/index.js:340`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L340) |
| `webauthn:get` | Request/Response | Handle assertion requests from renderer | [`app/webauthn/index.js:343`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L343) |
