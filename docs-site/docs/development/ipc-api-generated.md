...
>
> **Last Generated**: 2026-01-31T08:10:48.046Z
...
| `media-privacy:state` | Event | Handle media privacy state responses from renderer for MQTT publishing | [`app/index.js:369`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L369) |
| `media-privacy:state-changed` | Event | Handle media privacy state change notifications from renderer | [`app/index.js:378`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L378) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Request/Response | Notify when a call is connected | [`app/mainAppWindow/browserWindowManager.js:163`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L163) |
| `call-disconnected` | Request/Response | Notify when a call is disconnected | [`app/mainAppWindow/browserWindowManager.js:165`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L165) |
| `select-source` | Event | Handle screen sharing source selection from user | [`app/mainAppWindow/browserWindowManager.js:148`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L148) |
