...
>
> **Last Generated**: 2026-02-04T14:29:28.971Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Request/Response | Notify when a call is connected | [`app/mainAppWindow/browserWindowManager.js:175`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L175) |
| `call-disconnected` | Request/Response | Notify when a call is disconnected | [`app/mainAppWindow/browserWindowManager.js:177`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L177) |
| `select-source` | Event | Handle screen sharing source selection from user | [`app/mainAppWindow/browserWindowManager.js:160`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L160) |
...
| `graph-api-send-chat-message` | Request/Response | Send a chat message to a user via IC3 chat service | [`app/graphApi/ipcHandlers.js:50`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L50) |
...
| `quick-chat:open-chat` | Event | Open chat with a user via deep link | [`app/quickChat/index.js:36`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/quickChat/index.js#L36) |
