...
>
> **Last Generated**: 2026-02-13T21:19:23.805Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:141`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L141) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:167`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L167) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:143`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L143) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:190`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L190) |
| `media-privacy:state` | Event | No description available | [`app/index.js:332`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L332) |
| `media-privacy:state-changed` | Event | No description available | [`app/index.js:336`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L336) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:172`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L172) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:181`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L181) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:165`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L165) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:163`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L163) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Request/Response | Notify when a call is connected | [`app/mainAppWindow/browserWindowManager.js:185`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L185) |
| `call-disconnected` | Request/Response | Notify when a call is disconnected | [`app/mainAppWindow/browserWindowManager.js:187`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L187) |
| `select-source` | Event | Handle screen sharing source selection from user | [`app/mainAppWindow/browserWindowManager.js:170`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L170) |

## Menus & Tray

| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:177`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L177) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:183`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L183) |
...
| `graph-api-search-people` | Request/Response | Search people using People API (for Quick Chat feature) | [`app/graphApi/ipcHandlers.js:44`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L44) |
| `graph-api-send-chat-message` | Request/Response | Send a chat message to a user via Graph API | [`app/graphApi/ipcHandlers.js:50`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L50) |
