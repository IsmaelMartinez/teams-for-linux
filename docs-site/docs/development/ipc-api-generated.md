...
>
> **Last Generated**: 2025-11-30T08:23:36.955Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Event | Listen for call connect/disconnect events (from browserWindowManager.js) | [`app/mqtt/mediaStatusService.js:30`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L30) |
| `call-disconnected` | Event | No description available | [`app/mqtt/mediaStatusService.js:31`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L31) |
| `camera-state-changed` | Event | Listen for camera/microphone state changes (from browser mediaStatus.js - Phase 2) | [`app/mqtt/mediaStatusService.js:34`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L34) |
| `microphone-state-changed` | Event | No description available | [`app/mqtt/mediaStatusService.js:35`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L35) |
