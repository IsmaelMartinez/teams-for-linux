...
>
> **Last Generated**: 2026-09-25T16:09:50.806Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `offline-retry` | Event | Retry connection when user clicks retry button on offline page | [`app/connectionManager/index.js:51`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/connectionManager/index.js#L51) |

## Core Application

| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:245`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L245) |
| `dock-icon-update` | Event | Update Dock icon with status overlay on macOS | [`app/index.js:268`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L268) |
...
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:247`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L247) |
...
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:265`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L265) |
...
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:263`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L263) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Request/Response | Notify when a call is connected | [`app/mainAppWindow/browserWindowManager.js:135`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L135) |
| `call-disconnected` | Request/Response | Notify when a call is disconnected | [`app/mainAppWindow/browserWindowManager.js:137`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L137) |
| `profile-switcher-set-expanded` | Request/Response | Grow the view to full-window while the dropdown is open (so the scrim covers the app and the dropdown isn't clipped), shrink back to the corner pill on close; the renderer toggles this on dropdown open/close. | [`app/mainAppWindow/profileViewManager.js:196`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/profileViewManager.js#L196) |
| `screen-sharing-started` | Event | Opens the screen-share preview window (if enabled) and connects the Teams renderer to it with a direct MessagePort so a single capture feeds both windows (#2534). One of several listeners on this broadcast channel; see the rationale above. | [`app/mainAppWindow/index.js:762`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/index.js#L762) |
| `select-source` | Event | Handle screen sharing source selection from user | [`app/mainAppWindow/browserWindowManager.js:116`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L116) |

## Menus & Tray

| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:367`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L367) |
| `profile-switcher-open-add` | Event | Switcher pill "Add profile…" link opens the existing Add-profile dialog. | [`app/menus/index.js:242`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L242) |
| `profile-switcher-open-manage` | Event | Switcher pill "Manage profiles…" link opens the existing Manage dialog. | [`app/menus/index.js:244`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L244) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:457`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L457) |
...
| `webauthn:create` | Request/Response | Handle credential creation requests from renderer | [`app/webauthn/index.js:357`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L357) |
| `webauthn:get` | Request/Response | Handle assertion requests from renderer | [`app/webauthn/index.js:360`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L360) |
