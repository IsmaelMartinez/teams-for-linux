...
>
> **Last Generated**: 2026-06-16T14:41:21.833Z
...
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:344`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L344) |
...
| `profile-switcher-set-expanded` | Request/Response | Grow/shrink the switcher strip so its dropdown is not clipped by the collapsed 40px height; the renderer toggles this on dropdown open/close. | [`app/mainAppWindow/profileViewManager.js:145`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/profileViewManager.js#L145) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:267`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L267) |
| `profile-switcher-open-add` | Event | Switcher strip "Add profile…" link opens the existing Add-profile dialog. | [`app/menus/index.js:194`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L194) |
| `profile-switcher-open-manage` | Event | Switcher strip "Manage profiles…" link opens the existing Manage dialog. | [`app/menus/index.js:196`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L196) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:273`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L273) |
