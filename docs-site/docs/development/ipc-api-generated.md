...
>
> **Last Generated**: 2026-04-27T20:33:33.677Z
...
|---------|------|-------------|----------|
| `submitForm` | Event | Handle form submission for SSO/authentication workflows | [`app/login/index.js:18`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/login/index.js#L18) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:203`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L203) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:229`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L229) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:205`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L205) |
...
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:234`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L234) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:243`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L243) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:227`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L227) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:261`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L261) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:225`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L225) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:278`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L278) |
