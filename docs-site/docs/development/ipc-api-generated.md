...
>
> **Last Generated**: 2026-03-19T23:39:53.315Z
...
| `webauthn:create` | Request/Response | Handle credential creation requests from renderer | [`app/webauthn/index.js:262`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L262) |
| `webauthn:get` | Request/Response | Handle assertion requests from renderer | [`app/webauthn/index.js:265`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L265) |
| `webauthn:pin-cancel` | Event | Receive cancellation from the PIN dialog when user clicks Cancel or closes the window | [`app/webauthn/pinDialog.js:81`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L81) |
| `webauthn:pin-cancel` | Event | Receive cancellation from the PIN dialog when user clicks Cancel or closes the window | [`app/webauthn/pinDialog.js:161`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L161) |
| `webauthn:pin-submit` | Event | Receive PIN from the PIN dialog when user submits the form | [`app/webauthn/pinDialog.js:79`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L79) |
| `webauthn:pin-submit` | Event | Receive PIN from the PIN dialog when user submits the form | [`app/webauthn/pinDialog.js:159`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L159) |
