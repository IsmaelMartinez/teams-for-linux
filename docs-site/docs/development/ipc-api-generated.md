...
>
> **Last Generated**: 2026-03-19T23:20:37.650Z
...
| `webauthn:create` | Request/Response | Handle credential creation requests from renderer | [`app/webauthn/index.js:267`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L267) |
| `webauthn:get` | Request/Response | Handle assertion requests from renderer | [`app/webauthn/index.js:270`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/index.js#L270) |
| `webauthn:pin-cancel` | Event | Receive cancellation from the PIN dialog when user clicks Cancel or closes the window | [`app/webauthn/pinDialog.js:80`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L80) |
| `webauthn:pin-cancel` | Event | Receive cancellation from the PIN dialog when user clicks Cancel or closes the window | [`app/webauthn/pinDialog.js:293`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L293) |
| `webauthn:pin-submit` | Event | Receive PIN from the PIN dialog when user submits the form | [`app/webauthn/pinDialog.js:78`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L78) |
| `webauthn:pin-submit` | Event | Receive PIN from the PIN dialog when user submits the form | [`app/webauthn/pinDialog.js:291`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/webauthn/pinDialog.js#L291) |
