...
>
> **Last Generated**: 2026-04-30T07:04:10.361Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:210`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L210) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:241`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L241) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:212`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L212) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:264`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L264) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:246`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L246) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:255`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L255) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:239`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L239) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:273`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L273) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:237`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L237) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:290`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L290) |
...
| `profile-add` | Request/Response | ADR-020: persist a new profile; UI creates the matching view | [`app/profilesManager/index.js:60`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L60) |
| `profile-get-active` | Request/Response | ADR-020: return the currently active profile, or null | [`app/profilesManager/index.js:56`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L56) |
| `profile-list` | Request/Response | ADR-020: list every profile this user has configured | [`app/profilesManager/index.js:54`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L54) |
| `profile-remove` | Request/Response | ADR-020: delete a profile; UI is responsible for clearing storage | [`app/profilesManager/index.js:66`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L66) |
| `profile-switch` | Request/Response | ADR-020: mark a profile active; UI swaps the visible WebContentsView | [`app/profilesManager/index.js:58`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L58) |
| `profile-update` | Request/Response | ADR-020: patch a profile's metadata (name, avatar, pinned, etc.) | [`app/profilesManager/index.js:62`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L62) |
