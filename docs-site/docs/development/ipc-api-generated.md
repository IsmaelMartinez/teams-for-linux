...
>
> **Last Generated**: 2026-04-27T13:56:01.076Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:209`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L209) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:240`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L240) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:211`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L211) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:263`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L263) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:245`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L245) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:254`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L254) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:238`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L238) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:272`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L272) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:236`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L236) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:289`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L289) |
...
| `profile-add` | Request/Response | ADR-020: persist a new profile; UI creates the matching view | [`app/profilesManager/index.js:42`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L42) |
| `profile-get-active` | Request/Response | ADR-020: return the currently active profile, or null | [`app/profilesManager/index.js:38`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L38) |
| `profile-list` | Request/Response | ADR-020: list every profile this user has configured | [`app/profilesManager/index.js:36`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L36) |
| `profile-remove` | Request/Response | ADR-020: delete a profile; UI is responsible for clearing storage | [`app/profilesManager/index.js:48`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L48) |
| `profile-switch` | Request/Response | ADR-020: mark a profile active; UI swaps the visible WebContentsView | [`app/profilesManager/index.js:40`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L40) |
| `profile-update` | Request/Response | ADR-020: patch a profile's metadata (name, avatar, pinned, etc.) | [`app/profilesManager/index.js:44`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/profilesManager/index.js#L44) |
