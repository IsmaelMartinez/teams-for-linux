...
>
> **Last Generated**: 2026-02-02T12:14:09.492Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `graph-api-create-calendar-event` | Request/Response | Create a new calendar event | [`app/graphApi/ipcHandlers.js:33`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L33) |
| `graph-api-get-calendar-events` | Request/Response | Get calendar events with optional OData query options | [`app/graphApi/ipcHandlers.js:21`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L21) |
| `graph-api-get-calendar-view` | Request/Response | Get calendar view for a specific time range | [`app/graphApi/ipcHandlers.js:27`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L27) |
| `graph-api-get-mail-messages` | Request/Response | Get mail messages with optional OData query options | [`app/graphApi/ipcHandlers.js:39`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L39) |
...
| `graph-api-run-chat-spikes` | Request/Response | Run chat API validation spikes for testing chat modal feasibility | [`app/graphApi/ipcHandlers.js:45`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L45) |
