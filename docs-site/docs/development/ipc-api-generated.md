...
>
> **Last Generated**: 2026-06-22T10:28:18.477Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:254`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L254) |
| `dock-icon-update` | Event | Update Dock icon with status overlay on macOS | [`app/index.js:286`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L286) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:301`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L301) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:256`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L256) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:324`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L324) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:306`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L306) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:315`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L315) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:283`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L283) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:333`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L333) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:281`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L281) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:362`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L362) |
...
| `secure-prompt:cancel` | Event | Dialog cancelled by the user (Cancel button) | [`app/_shared/securePrompt.js:58`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/_shared/securePrompt.js#L58) |
| `secure-prompt:submit` | Event | Secret submitted from a dialog form | [`app/_shared/securePrompt.js:56`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/_shared/securePrompt.js#L56) |
