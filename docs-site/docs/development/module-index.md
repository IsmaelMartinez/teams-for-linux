...
| **Speaking Indicator** | `app/browser/tools/speakingIndicator.js` | Real-time microphone input overlay during calls | [Research](./research/speaking-indicator-research.md) |
