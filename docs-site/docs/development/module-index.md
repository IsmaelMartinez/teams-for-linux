...
| **SSO Password Pre-fill** | `app/ssoPasswordPrefill/` | Opt-in pre-fill of the Microsoft/federated **web** sign-in form: account, password and authenticator one-time code from a command, optional auto-advance and MFA method ([#2794](https://github.com/IsmaelMartinez/teams-for-linux/issues/2794), [#2869](https://github.com/IsmaelMartinez/teams-for-linux/issues/2869)). Distinct from `app/login/`, which drives the native HTTP Basic/NTLM dialog. | [README](https://github.com/IsmaelMartinez/teams-for-linux/blob/main/app/ssoPasswordPrefill/README.md) |
