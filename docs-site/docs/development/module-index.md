...
| **Speaking Indicator** | `app/browser/tools/speakingIndicator.js` | Visual overlay showing local microphone audio capture during calls (speaking/silent) | [Research](./research/speaking-indicator-research.md) |
