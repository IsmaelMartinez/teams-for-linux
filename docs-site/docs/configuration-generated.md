...
| `ssoInAppAutoSubmit` | `boolean` | `false` | When ssoInAppPasswordCommand is set, automatically click the sign-in button after pre-filling the password. Off by default so you review and submit yourself. | `restart` |
