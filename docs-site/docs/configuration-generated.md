...
| `screenSharing.resolution.mode` | `string` | `"remove"` | Resolution mode: remove removes Teams' screen sharing limits so capture can use its native resolution; override requests the configured width and height as a ceiling. |
