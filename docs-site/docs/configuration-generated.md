...
| `notifications.taskbarBadgeEnabled` | `boolean` | `true` | Show the unread count badge on the taskbar/dock icon (macOS dock, and Linux docks implementing the Unity LauncherEntry protocol). |
