...
| `msTeamsProtocols` | `object` | `{ v1: "^msteams:\/(?:l\/(?:meetup-join\|channel\|chat\|message)\|meet)\/", v2: "^msteams:\/\/teams.(?:microsoft.com\|live.com\|cloud.microsoft)\/(?:l\/(?:meetup-join\|channel\|chat\|message)\|meet)\/" }` | Regular expressions for Microsoft Teams protocol links |
