...
- [Configuration Options](#configuration-options)
  ...
  - [Usage Examples \& Guides](#usage-examples--guides)
    - [Basic Setup Examples](#basic-setup-examples)
      ...
      - [Dark Theme with Notifications Disabled](#dark-theme-with-notifications-disabled)
      - [Enterprise Setup](#enterprise-setup)
      - [Professional Audio Setup](#professional-audio-setup)
      - [Custom Notifications Setup](#custom-notifications-setup)
    - [System-wide Configuration](#system-wide-configuration)
      - [Configuration Precedence](#configuration-precedence)
      - [Example System-wide Config](#example-system-wide-config)
    - [Electron CLI Flags](#electron-cli-flags)
      - [Custom Feature Flags (enable-features / disable-features)](#custom-feature-flags-enable-features--disable-features)
    - [Incoming Call Command](#incoming-call-command)
    - [Cache Management](#cache-management)
      - [What Gets Cleaned vs Preserved](#what-gets-cleaned-vs-preserved)
    ...
    - [Tray Icon Behavior by Desktop Environment](#tray-icon-behavior-by-desktop-environment)
      - [Visual Badge Support](#visual-badge-support)
      - [Cinnamon Users](#cinnamon-users)
    - [Global Shortcuts](#global-shortcuts)
      - [Configuration Example](#configuration-example)
      - [Common Teams Shortcuts](#common-teams-shortcuts)
