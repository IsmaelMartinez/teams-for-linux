    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'development/ai/ai-collaboration',
            'development/ai/ai-philosophy',
            'development/ai/ai-quick-reference',
            'development/ai/ai-methodology',
            {
              type: 'category',
              label: 'Article Series',
              collapsed: true,
              items: [
                'development/ai/articles/ai-article-series',
                'development/ai/articles/ai-how-i-work',
                'development/ai/articles/ai-poc-trap',
                'development/ai/articles/ai-security-tax',
                'development/ai/articles/ai-team-adoption',
                'development/ai/articles/ai-safe-starting',
                'development/ai/articles/ai-for-juniors',
                'development/ai/articles/ai-deployment',
              ],
            },
            {
              type: 'category',
              label: 'Frameworks & Examples',
              collapsed: true,
              items: [
                'development/ai/frameworks/ai-evolution',
                'development/ai/frameworks/ai-when-to-skip',
                'development/ai/examples/ai-example-research',
                'development/ai/examples/ai-example-spike',
                'development/ai/examples/ai-example-gate',
              ],
            },
            'development/ai/ai-glossary',
          ],
        },
        {
          type: 'category',
