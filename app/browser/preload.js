...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    const modules = [
      ...
      { name: "appRegistrationAuth", path: "./tools/appRegistrationAuth" }
    ];

    // CRITICAL: These modules need ipcRenderer for IPC communication (see CLAUDE.md)
    const modulesRequiringIpc = new Set(["settings", "theme", "trayIconRenderer", "mqttStatusMonitor", "meetingStartDetector", "webauthnOverride", "speakingIndicator", "customStickers", "dockIconRenderer", "appRegistrationAuth"]);
