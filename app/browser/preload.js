...
// Config is fetched asynchronously but notification class references it via closure
...
// The CustomNotification class will use notificationConfig via closure
(function() {
  const ICON_BASE64 =
  ...
  console.log("Preload: CustomNotification class initialized");
})();
