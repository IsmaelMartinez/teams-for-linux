  ...
  constructor(title, options) {
    ...
    const handleWebNotification = (notifSound) => {
      if (window.electronAPI && typeof window.electronAPI.playNotificationSound === "function") {
        try {
          window.electronAPI.playNotificationSound(notifSound);
        } catch (e) {
    ...
    // Handle notifications immediately if we have config, otherwise get it async
...
// Override window.Notification with our custom implementation
