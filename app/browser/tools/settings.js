...
const _Settings_config = new WeakMap();
const _Settings_ipcRenderer = new WeakMap();

class Settings {
	init(config, ipcRenderer) {
		_Settings_config.set(this, config);
		_Settings_ipcRenderer.set(this, ipcRenderer);
		this.ipcRenderer.on("get-teams-settings", retrieve.bind(this));
		this.ipcRenderer.on("set-teams-settings", restore.bind(this));
	}
