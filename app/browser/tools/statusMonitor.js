...
let _StatusMonitor_config = new WeakMap();
let _StatusMonitor_ipcRenderer = new WeakMap();
let lastStatus = null;
let observer = null;

class StatusMonitor {
	init(config, ipcRenderer) {
		_StatusMonitor_config.set(this, config);
		_StatusMonitor_ipcRenderer.set(this, ipcRenderer);
		this.start();
	}

	get config() {
		return _StatusMonitor_config.get(this);
	}

	get ipcRenderer() {
		return _StatusMonitor_ipcRenderer.get(this);
	}
