...
module.exports = {
	...
	type: "object",
      ...
      media: {
        ...
        describe: "Media settings for microphone, camera, and video. preventDeviceSwitching: prevent automatic audio/video device switching by blocking device change notifications. showStatusOnDockIcon: overlay the user presence status on the Dock icon on macOS.",
        type: "object",
      },
      mqtt: {
        default: {
