...
// Create require function for loading JSON config files
...
// Map of deprecated options and their replacement messages
const DEPRECATED_OPTIONS = {
	// Add deprecated options here as needed, e.g.:
	// "oldOption": "Use `newOption` instead"
};

function checkUsedDeprecatedValues(configObject, config) {
	for (const option in DEPRECATED_OPTIONS) {
