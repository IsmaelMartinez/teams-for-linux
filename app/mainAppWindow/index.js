...
import { StreamSelector } from "../screenSharing/index.js";
import * as login from "../login/index.js";
import * as customCSS from "../customCSS/index.js";
import Menus from "../menus/index.js";
import { SpellCheckProvider } from "../spellCheckProvider/index.js";
import { execFile } from "node:child_process";
import TrayIconChooser from "../browser/tools/trayIconChooser.js";
import ConnectionManager from "../connectionManager/index.js";
import BrowserWindowManager from "../mainAppWindow/browserWindowManager.js";
...
export async function onAppReady(configGroup, customBackground, sharingService) {
	...
	if (config.ssoInTuneEnabled) {
		intune = await import("../intune/index.js");
...
export function onAppSecondInstance(event, args) {
