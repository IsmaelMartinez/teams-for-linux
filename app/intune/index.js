...
export async function initSso(ssoInTuneAuthUser) {
...
export function setupUrlFilter(filter) {
	filter.urls.push("https://login.microsoftonline.com/*");
}

export function isSsoUrl(url) {
	return (
		inTuneAccount != null &&
...
export function addSsoCookie(detail, callback) {
