(function () {
  // NOTIFICATION INTERCEPTION SCRIPT
  // 
  // This script runs in the Teams webpage context and overrides window.Notification
  // to intercept Teams' notification calls and redirect them to Electron's notification
  // system. This enables tray icon badge counts and system notification integration.
  //
  // CRITICAL: Must be injected after page load but before Teams initializes notifications.
  //
  // Architecture:
  // Teams calls new Notification() → CustomNotification → electronAPI → Main Process
  //
  const ICON_BASE64 =
